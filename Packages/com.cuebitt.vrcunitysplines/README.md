...
Unity's Splines package isn't whitelisted by VRChat, so this package bakes your splines in the editor instead. Animation clips end up in your world, and only whitelisted runtime components are used.
